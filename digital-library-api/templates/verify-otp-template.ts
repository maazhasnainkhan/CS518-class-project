const verifyOTP = function (otp: string) {
    const html = `
    <!DOCTYPE html>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            Below is the OTP you requested,
                          </p>
                          ...
                          <p style="margin: 0 0 16px;">
                            ...
                            <a href="mailto:mkhan016@odu.edu" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">mkhan016@odu.edu</a>.
                          </p>
                          <p style="margin: 0 0 16px;">Thanks, <br>Support Team</p>
                        </td>
                      </tr>
                      <tr>
